...
export default function HomeScreen(){
  return(
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Link href="/(tabs)/events" style={styles.linkButton}>
...
const styles = StyleSheet.create({
  ...
  welcome: { color: '#fff', fontSize: 22, fontWeight: 'bold', marginBottom: 16 },
  statsRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 24 },
  linkButton: { backgroundColor: '#3700b3', padding: 14, borderRadius: 8, alignItems: 'center' },
